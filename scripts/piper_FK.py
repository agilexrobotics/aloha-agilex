...
class RosOperator:
    ...
    def init_ros(self):
        ...
        self.arm_joint_state_subscriber = rospy.Subscriber(f'/joint_states_single_gripper{self.args.index_name}', JointState, self.arm_joint_state_callback, queue_size=1)
